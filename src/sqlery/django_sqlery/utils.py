"""Utility functions for sqlery Django integration.
...
from sqlery.core.utils import calculate_next_run, validate_cron_expression, import_task
...
def enqueue_task(task):
    """Enqueue a scheduled task immediately.

    Args:
        task: ScheduledTask instance

    Returns:
        QueuedJob: The created job
    """
